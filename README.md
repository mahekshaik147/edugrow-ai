...
🎯 Personalized adaptive learning flow
...
Backend: Supabase
Styling: TailwindCSS (if enabled)
...
🧠 Notes
Built using TanStack Start template structure
Routing handled via file-based system in src/routes
Supabase manages authentication, database, and storage
