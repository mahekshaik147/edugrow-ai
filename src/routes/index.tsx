...
function Features() {
  const items = [
    { icon: Brain, title: "Adaptive Brain Skills", desc: "Memory, logic, patterns and problem-solving skill tests that adapt to your child's level.", grad: "gradient-hero" },
...
function HowItWorks() {
  const steps = [
    ...
    { n: "2", title: "Train & learn", desc: "Quick brain skill tests, AI chats, and adaptive puzzles. 10 min/day is plenty.", emoji: "🧠" },
